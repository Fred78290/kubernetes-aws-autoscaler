...
import (
	...
	nodemanager "github.com/Fred78290/kubernetes-aws-autoscaler/pkg/apis/nodemanager"
	v1alpha1 "github.com/Fred78290/kubernetes-aws-autoscaler/pkg/apis/nodemanager/v1alpha1"
	schemeclientset "github.com/Fred78290/kubernetes-aws-autoscaler/pkg/generated/clientset/versioned/scheme"
	informers "github.com/Fred78290/kubernetes-aws-autoscaler/pkg/generated/informers/externalversions"
	listers "github.com/Fred78290/kubernetes-aws-autoscaler/pkg/generated/listers/nodemanager/v1alpha1"
				...
				if key, found := managedNodesByUID[node.UID]; found {
					if managedNode, err := c.getManagedNodeFromKey(key); err == nil {
						...
						if node.State == AutoScalerServerNodeStateRunning {
							...
							newStatus.InstanceID = *node.runningInstance.InstanceID
							...
							if workerNode, err := c.client.GetNode(node.NodeName); err != nil {
								err = fmt.Errorf("unable to find core node %s, reason: %v", node.NodeName, err)
